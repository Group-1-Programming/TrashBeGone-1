...
namespace TrashBeGone
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(TrashBeGoneContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Admin != null ? 
                          ...
                          Problem("Entity set 'TrashBeGoneContext.Admin'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TrashBeGoneContext.Admin'  is null.");
            }
            var admin = await _context.Admin.FindAsync(id);
            if (admin != null)
            {
